export const config = {
    ...
    og: {
        title: "Bernard Polidario — Software Engineer",
        description: "I design web apps for human satisfaction. A software engineer based in France.",
        image: "@/assets/images/portfolio-banner.webp",
        url: "https://polidario.com/",
        type: "website",
        site_name: "Bernard Polidario",
        locale: "en_US"
    }
}